...
CREATE TABLE PAYMENT1(
        ...
        CNAME VARCHAR2(50) NOT NULL,
        TOTAL NUMBER,
        CONSTRAINT PK_PAY_MNO1 PRIMARY KEY(MNO),
        CONSTRAINT CHK_PAY_TOTAL1 CHECK(TOTAL > 0)
);
...
CREATE TABLE PAYMENT_DETAIL(
        ...
        CONSTRAINT CHK_PAY_DETAIL_TOTAL_PRICE CHECK(TOTAL_PRICE > 0)
);
...
CREATE TABLE PAYMENT_DETAIL1(
        ...
        CONSTRAINT CHK_PAY_DET_TPR1 CHECK(TOTAL_PRICE > 0)
);
